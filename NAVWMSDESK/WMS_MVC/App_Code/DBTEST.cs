...
using System.Threading.Tasks;
    ...
    public class DBTEST
    {
        ...
        public DBTEST()
        {
           // con = new SqlConnection(@"Database=NAVWMS;Server=192.168.8.235; user ID=sa;Password=Btq@123!;Connect Timeout=200;pooling='true'; Max Pool Size=200");
            con = new SqlConnection(@"Database=NAVWMS;Server=192.168.11.13; user ID=ERPWEB ;Password=96V!F=I9[;Connect Timeout=2000;pooling='true'; Max Pool Size=200");
            cmd = new SqlCommand();
        }
